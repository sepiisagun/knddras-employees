					...
					<ModalBody p={50}>
						...
						<Box py={4}>
							...
							<Box>
								...
								("Company," "we," "us," "our"), a company
								registered in the Philippines at Abanao Street,
								Baguio City, Benguet 2600. We operate the
								website https://knddras-clients.sefserver.de/
						...
						<Box py={4}>
							<Heading as="h3" py={3} size="lg">
								Klinika ng Dentista Dental Records and
								Appointment System (KNDDRAS) is a web
								application designed to help patients set up
								check-up and treatment appointments and manage
								their dental records online.
							</Heading>
							<Text>
								You can contact us by phone at (074) 300 3850,
								email at <Text as="span">knd@gmail.com</Text>,
								or by mail to Abanao Street, Baguio City,
								Benguet 2600, Philippines. These Legal Terms
								constitute a legally binding agreement made
								between you, whether personally or on behalf of
								an entity ("you"), and Klinika ng Dentista,
								...
								IMMEDIATELY. We will provide you with prior
								notice of any scheduled changes to the Services
								you are using. The modified Legal Terms will
								become effective upon posting or notifying you
								by knd@gmail.com, as stated in the email
								message. By continuing to use the Services after
								the effective date of any changes, you agree to
								be bound by the modified terms. All users who
								are minors in the jurisdiction in which they
								reside (generally under the age of 18) must have
								the permission of, and be directly supervised
								by, their parent or guardian to use the
						...
						<Box py={4}>
							...
							<Text>
								Our intellectual property We are the owner or
								the licensee of all intellectual property rights
								in our Services, including all source code,
								...
								"Marks"). Our Content and Marks are protected by
								...
								States and around the world. The Content and
								Marks are provided in or through the Services
								"AS IS" for your personal, non-commercial use or
								internal business purpose only. Your use of our
								Services Subject to your compliance with these
								Legal Terms, including the "PROHIBITED
								ACTIVITIES" section below, we grant you a
								non-exclusive, non-transferable, revocable
								license to: access the Services; and download or
								...
								internal business purpose. Except as set out in
								this section or elsewhere in our Legal Terms, no
								part of the Services and no Content or Marks may
								...
								express prior written permission. If you wish to
								make any use of the Services, Content, or Marks
								other than as set out in this section or
								elsewhere in our Legal Terms, please address
								your request to: knd@gmail.com. If we ever grant
								you the permission to post, reproduce, or
								...
								or displaying our Content. We reserve all rights
								not expressly granted to you in and to the
								Services, Content, and Marks. Any breach of
								these Intellectual Property Rights will
								constitute a material breach of our Legal Terms
								and your right to use our Services will
								terminate immediately. Your submissions and
								contributions Please review this section and the
								"PROHIBITED ACTIVITIES" section carefully prior
								to using our Services to understand the (a)
								rights you give us and (b) obligations you have
								when you post or upload any content through the
								Services. Submissions: By directly sending us
								any question, comment, suggestion, idea,
								...
								Submission and be entitled to its unrestricted
								use and dissemination for any lawful purpose,
								commercial or otherwise, without acknowledgment
								or compensation to you. Contributions: The
								Services may invite you to chat, contribute to,
								or participate in blogs, message boards, online
								forums, and other functionality during which you
								may create, submit, post, display, transmit,
								publish, distribute, or broadcast content and
								materials to us or through the Services,
								including but not limited to text, writings,
								video, audio, photographs, music, graphics,
								...
								Contribution. You understand that Contributions
								may be viewable by other users of the Services.
								When you post Contributions, you grant us a
								license (including use of your name, trademarks,
								and logos): By posting any Contributions, you
								grant us an unrestricted, unlimited,
								irrevocable, perpetual, non-exclusive,
								transferable, royalty-free, fully-paid,
								worldwide right, and license to: use, copy,
								reproduce, distribute, sell, resell, publish,
								broadcast, retitle, store, publicly perform,
								publicly display, reformat, translate, excerpt
								(in whole or in part), and exploit your
								Contributions (including, without limitation,
								your image, name, and voice) for any purpose,
								commercial, advertising, or otherwise, to
								...
								Our use and distribution may occur in any media
								formats and through any media channels. This
								license includes our use of your name, company
								name, and franchise name, as applicable, and any
								of the trademarks, service marks, trade names,
								logos, and personal and commercial images you
								provide. You are responsible for what you post
								or upload: By sending us Submissions and/or
								posting Contributions through any part of the
								Services or making Contributions accessible
								through the Services by linking your account
								through the Services to any of your social
								networking accounts, you:
								<UnorderedList pl={8}>
									<ListItem>
										confirm that you have read and agree
										with our "PROHIBITED ACTIVITIES" and
										will not post, send, publish, upload, or
										...
										abusive, discriminatory, threatening to
										any person or group, sexually explicit,
										false, inaccurate, deceitful, or
										misleading;
									</ListItem>
									<ListItem>
										to the extent permissible by applicable
										law, waive any and all moral rights to
									...
									<ListItem>
										...
										and/or Contributions and that you have
										full authority to grant us the
										above-mentioned rights in relation to
										your Submissions and/or Contributions;
										and
									</ListItem>
									<ListItem>
										warrant and represent that your
										Submissions and/or Contributions do not
										constitute confidential information.
									</ListItem>
								</UnorderedList>
								You are solely responsible for your Submissions
								and/or Contributions and you expressly agree to
								reimburse us for any and all losses that we may
								suffer because of your breach of (a) this
								section, (b) any third party’s intellectual
								property rights, or (c) applicable law. We may
								remove or edit your Content: Although we have no
								obligation to monitor any Contributions, we
								shall have the right to remove or edit any
								Contributions at any time without notice if in
								our reasonable opinion we consider such
								Contributions harmful or in breach of these
								Legal Terms. If we remove or edit any such
								Contributions, we may also suspend or disable
								...
								believe that any material available on or
								through the Services infringes upon any
						...
						<Box py={4}>
							...
							<Text>
								...
								with these Legal Terms; (4) you are not a minor
								in the jurisdiction in which you reside, or if a
								minor, you have received parental permission to
								use the Services; (5) you will not access the
								...
								unauthorized purpose; and (7) your use of the
								Services will not violate any applicable law or
								regulation. If you provide any information that
								...
								current or future use of the Services (or any
								portion thereof).
							</Text>
						</Box>
						<Box py={4}>
						...
						<Box py={4}>
							...
							<Text>
								...
								approved by us. As a user of the Services, you
								agree not to:
								<UnorderedList pl={8}>
									<ListItem>
									...
									<ListItem>
										Trick, defraud, or mislead you or other
										users, especially in any attempt to
										learn sensitive account information such
										as user passwords.
									</ListItem>
									<ListItem>
										Systematically retrieving data or
										content from your Site to create a
										collection or database without written
										permission from you.
									</ListItem>
									<ListItem>
										Circumvent, disable, or otherwise
										interfere with security-related features
										of KNDDRAS. This includes features that
										prevent/restrict the use of any content
										limits site usage.
									</ListItem>
									<ListItem>
										Harass, abuse, or harm another person
										using any information obtained from
										KNDDRAS.
									</ListItem>
									<ListItem>
										Framing or linking to KNDDRAS without
										authorization.
									</ListItem>
									<ListItem>
										Attempt to upload or transmit viruses,
										Trojan horses, malicious scripts, or
										other materials (including excessive use
										of capital letters and spamming) that
										interferes with any party’s
										uninterrupted use of KNDDRAS and its
										features.
									</ListItem>
									<ListItem>
										Use scripts, data-mining, robots, or
										similar data gathering tools to send
									...
									<ListItem>
										Impersonate another user or person or
										use the username of another user.
									</ListItem>
									<ListItem>
										Upload any materials that actively or
										passively collects information or acts
										as a transmission mechanism (includes
										gifs, 1x1 pixels, web bugs, cookies,
										spyware, pcms, etc.)
									</ListItem>
									<ListItem>
										Interfere, disrupt, or create an undue
										burden on KNDDRAS's services.
									</ListItem>
									<ListItem>
										Harass, annoy, intimidate, or threaten
										any of our employees or agents engaged
										in providing any portion of KNDDRAS to
										you.
									</ListItem>
									<ListItem>
										Bypass measures of KNDDRAS designed to
										prevent/restrict access.
									</ListItem>
									<ListItem>
										Decipher, decompile, disassemble, or
										reverse engineer any of the software
										that makes up KNDDRAS.
									</ListItem>
									<ListItem>
										Use KNDDRAS in an unauthorized way
										(collecting usernames, email addresses,
										of users for the purpose of sending
						...
						<Box py={4}>
							...
							<Text>
								...
								(collectively, "Contributions"). Contributions
								may be viewable by other users of the Services
								...
								<UnorderedList pl={8}>
									...
									<ListItem>
										...
										use and to authorize us, the Services,
						...
						<Box py={4}>
							...
							<Text>
								...
								Services, you automatically grant, and you
								...
								through any media channels. This license will
								...
								been asserted in your Contributions. We do not
								assert any ownership over your Contributions.
								You retain full ownership of all of your
								Contributions and any intellectual property
						...
						<Box py={4}>
							...
							<Text>
								...
								https://knddras-clients.sefserver.de/privacy-policy.
								By using the Services, you agree to be bound by
								our Privacy Policy, which is incorporated into
								these Legal Terms. Please be advised the
								Services are hosted in the Philippines. If you
								...
								that differ from applicable laws in the
								Philippines, then through your continued use of
								the Services, you are transferring your data to
								the Philippines, and you expressly consent to
						...
						<Box py={4}>
							...
							<Text>
								...
								linked to by the Services infringes your
						...
						<Box py={4}>
							...
							<Text>
								...
								PARTICIPATION IN THE SERVICES OR DELETE YOUR
								ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU
								POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE
								DISCRETION. If we terminate or suspend your
								account for any reason, you are prohibited from
								registering and creating a new account under
								your name, a fake or borrowed name, or the name
								of any third party, even if you may be acting on
						...
						<Box py={4}>
							...
							<Text>
								...
								discontinuance of the Services. We cannot
								guarantee the Services will be available at all
								times. We may experience hardware, software, or
								other problems or need to perform maintenance
								related to the Services, resulting in
								interruptions, delays, or errors. We reserve the
								right to change, revise, update, suspend,
								discontinue, or otherwise modify the Services at
								any time or for any reason without notice to
						...
						<Box py={4}>
							...
							<Text>
								...
								defined following the laws of the Philippines.
								Klinika ng Dentista and yourself irrevocably
								consent that the courts of the Philippines shall
								have exclusive jurisdiction to resolve any
						...
						<Box py={4}>
							...
							<Text>
								...
								related to these Legal Terms or the legal
								relationship established by these Legal Terms to
								the jurisdiction of the Philippines courts.
								Klinika ng Dentista shall also maintain the
								right to bring proceedings as to the substance
								of the matter in the courts of the country where
								you reside or, if these Legal Terms are entered
								into in the course of your trade or profession,
						...
						<Box py={4}>
							...
							<Text>
								...
								OR FROM THE SERVICES, (5) ANY BUGS, VIRUSES,
								TROJAN HORSES, OR THE LIKE WHICH MAY BE
								TRANSMITTED TO OR THROUGH THE SERVICES BY ANY
								THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS
								IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR
								DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE
								USE OF ANY CONTENT POSTED, TRANSMITTED, OR
								OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO
								...
								THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY
						...
						<Box py={4}>
							...
							<Text>
								...
								USE OF THE SERVICES, EVEN IF WE HAVE BEEN
						...
						<Box py={4}>
							...
							<Text>
								...
								arising out of: (1) your Contributions; (2) use
								of the Services; (3) breach of these Legal
								...
								toward any other user of the Services with whom
								you connected via the Services. Notwithstanding
						...
						<Box py={4}>
							...
							<Box pl={8}>
								<Text>Klinika ng Dentista</Text>
								<Text>Abanao Street</Text>
								<Text>Baguio City, Benguet 2600</Text>
								<Text>Philippines</Text>
								<Text>Phone: (074) 300 3850</Text>
								<Text>Email: knd@gmail.com</Text>
							</Box>
						</Box>
						<Divider />
						{/* PRIVACY POLICY */}
						...
						<Box py={4}>
							<Box>
								This privacy notice for Klinika ng Dentista
								...
								<UnorderedList pl={8} py={2}>
									<ListItem>
										...
										https://knddras-clients.sefserver.de/,
						...
						<Box py={4}>
							...
							<Box py={2}>
								<Text>
									...
									information when necessary with your consent
						...
						<Box py={4}>
							...
							<Box>
								...
								otherwise permitted by applicable law, we
								process the following categories of sensitive
								information:
								<UnorderedList pl={8} py={2}>
								...
								<UnorderedList pl={8} py={2}>
									<ListItem>
										...
										>
											...
											authentication and otherwise manage
											user accounts.
										</Text>
										We may process your information so you
										can create and log in to your account,
										as well as keep your account in working
										order.
									</ListItem>
									<ListItem>
										<Text
									...
									<ListItem>
										...
										you details about our products and
										services, changes to our terms and
							...
							<Box>
								...
								<UnorderedList pl={8} py={2}>
									<ListItem>
										...
										during negotiations of, any merger, sale
										of company assets, financing, or
						...
						<Box py={4}>
							...
							<Box>
								...
								longer than sixty (60) months past the start of
								the idle period of the user's account. When we
